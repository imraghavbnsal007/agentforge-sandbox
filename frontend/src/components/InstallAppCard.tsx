...
export function InstallAppCard({
  ...
  return (
    <div className="card p-6">
      ...
      {/* Same tab, deliberately: GitHub redirects back into AgentForge once
          the install is granted, and a new tab would strand that result away
          from the page the user started on. */}
      <a
        href={installUrl}
